 ...
 try{
    ...
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        if (isset($_POST['action'])){         
            $sql="SELECT * FROM adoption WHERE  decision='en avance'";
            $stmt = $pdo->query($sql);
...
<div class="d-flex p-1 grid gap-1">
    <h6 class="border-bottom pb-2 mb-0">Toute les demandes mis en avance</h6>
    <button class="btn btn-danger deleteallencours" style="position: relative;margin:auto;">vider la liste</button>
</div>
...
<?php
               ...
               echo"la liste de demande mis en avance est vide...";
           }
       }else{
