 ...
 try{
    ...
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        if (isset($_POST['action'])){         
            $sql="SELECT * FROM adoption WHERE  decision='encours'";
            $stmt = $pdo->query($sql);
...
<div class="d-flex p-1 grid gap-1">
    ...
    <button class="btn btn-danger deleteallenavance" style="position: relative;margin:auto;">vider la liste</button>
</div>
...
<?php
               ...
               echo"la liste de demande en cours est vide...";
           }
       }else{
