...
<div class="page-section">
    <div class="container">
        <h1 class="text-center wow fadeInUp">Register Someone</h1>
            ...
            <div class="row mt-2 ">
                ...
                <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
                    <select name="sex" id="departement" class="custom-select">
                        <option disabled value="general">sex</option>
                ...
                <div class="col-12 col-sm-12 py-2 wow fadeInRight" data-wow-delay="300ms">
                    <select name="role" id="departement" class="custom-select">
                        <option disabled value="general">role of user</option>
