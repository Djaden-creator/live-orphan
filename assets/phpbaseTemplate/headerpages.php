                ...
                try{
                    ...
                    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                     if(isset($_SESSION['idUser'])){
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="allmessage.php?itsme=<?php echo $rows['name'];?>/<?php echo md5($rows['name']);?>">
                                messages
                                <span
                        ...
                        <li class="nav-item d-flex">
                            ...
                            <a class="nav-link" href="profil.php?itsme=<?php echo $rows['name'];?>/
                                <?php echo md5($rows['name']);?>"><?php echo $_SESSION['name'] ;?></a>
                        </li>
                        <li class="nav-item">
